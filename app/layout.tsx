      ...
      <body className="relative min-h-[100dvh] antialiased">
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at center, rgba(255,176,32,0.20), rgba(255,138,0,0.07) 42%, transparent 68%)",
            }}
          />
          <div
            ...
            style={{
              background:
                "radial-gradient(circle at center, rgba(116,208,255,0.14), transparent 66%)",
            }}
          />
