  ...
  return (
    <div>
      ...
      <input
        ...
        className="mt-2.5 h-1.5 w-full cursor-pointer appearance-none rounded-full outline-none [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-solar [&::-webkit-slider-thumb]:shadow-[0_0_0_4px_rgba(34,197,94,0.18)] [&::-webkit-slider-thumb]:transition-transform [&::-webkit-slider-thumb]:duration-300 hover:[&::-webkit-slider-thumb]:scale-110 [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:bg-solar"
        style={{
          background: `linear-gradient(to right, var(--color-solar) ${pct}%, rgba(255,255,255,0.09) ${pct}%)`,
        }}
      />
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "bg-solar text-ink shadow-[0_2px_12px_rgba(255,176,32,0.24)]"
